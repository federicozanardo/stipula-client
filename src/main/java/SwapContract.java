...
public class SwapContract {
    private static final String contractId = "d50ed1a3-7a65-4238-867e-df48536b7243";
    private static final String contractInstanceId = "e9cbb96e-4d20-47d2-80e6-5b56701800b1";
    ...
    public static void main(ResponseDeserializer responseDeserializer) throws Exception {
        ...
        if (socket != null) {
            ...
            // SignedMessage signedMessage = callDepositAssetBAndSwapFunction(path);
    ...
    private static SignedMessage callDepositAssetBAndSwapFunction(String path) throws Exception {
        Base64.Encoder encoder = Base64.getEncoder();
        ...
        FunctionCall functionCall = new FunctionCall(contractInstanceId, "depositAssetBAndSwap", arguments);
